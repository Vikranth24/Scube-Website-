...
public class White_Order_test extends Base_Class {
	...
	/*	ReadExcel a=new ReadExcel();
		...
		*/
		...
		Thread.sleep(3000);
		pro.whitelabelyournametextfield("vik");
		Thread.sleep(3000);
		pro.whitelabeldesignationtextfiled("abs");
		Thread.sleep(3000);
		pro.whitelabelcard6phonenumber("9900334737");
		Thread.sleep(3000);
		...
		System.out.println("White_Order_test is pass");
