...
public class Executive_Order_test extends Base_Class {
	...
	/*	ReadExcel a=new ReadExcel();
		...
		*/
		...
		pro.CACARD8click();
		Thread.sleep(5000);
		pro.cacard8yourname("Vik");
		Thread.sleep(5000);
		pro.cacard8phonenumber("9900234730");
		Thread.sleep(5000);
		pro.cacard8yourdesignation("test");
		Thread.sleep(5000);
		pro. cacard8youremail("test@gmail.com");
		Thread.sleep(5000);
		...
		System.out.println("Executive_Order_test is pass");
