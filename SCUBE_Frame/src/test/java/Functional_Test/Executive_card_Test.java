...
public class Executive_card_Test extends Base_Class {
	...
	public void Home_Functional() throws InterruptedException {
		...
		/*
		 * ReadExcel a=new ReadExcel(); String
		 * des_name=a.readStringDataFromExcel("Sheet5", 0, 0); String
		 * des_email=a.readStringDataFromExcel("Sheet5", 0, 1); String
		 * des_no=a.readStringDataFromExcel("Sheet5", 0, 2);
		 */
		...
		pro.yournametextfield("viik");
		Thread.sleep(5000);
		pro.youremailtextfield("Vik@gmail.com");
		Thread.sleep(5000);
		pro.yourphonenumber("9900990099");
		Thread.sleep(5000);
		pro.submitclick();
		Thread.sleep(5000);
	     System.out.println("Executive_card_Test is pass");
