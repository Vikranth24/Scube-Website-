...
public class Click_here_Test extends Base_Class {
	...
	/*	ReadExcel a=new ReadExcel();
		...
		String email=a.readStringDataFromExcel("Sheet8", 0, 1)		String phone=a.readStringDataFromExcel("Sheet8", 0, 2);
*/
		...
		pro.clickhere();
		Thread.sleep(5000);
		pro.yournametextfield("vik");
		Thread.sleep(5000);
		pro.youremailtextfield("aa@gmail.com");
		Thread.sleep(5000);
		pro.yourphonenumber("9900234737");
		Thread.sleep(5000);
		pro.submitclick();
		Thread.sleep(5000);	
		System.out.println("Click_here_Test pass");
